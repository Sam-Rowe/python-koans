...
class AboutComprehension(Koan):
    ...
    def test_double_list_comprehension(self):
        list_of_eggs = ['poached egg', 'fried egg','scrambled egg']
        ...
        self.assertEqual(9, len(comprehension))
    ...
    def test_creating_a_dictionary_with_dictionary_comprehension(self):
        ...
        dict_comprehension = { k.upper(): weapon for k, weapon in dict_of_weapons.iteritems() if weapon} #Now thats some code golfing in Python. I am getting interested, its like Ruby but not as readable!
